...
function hasStoryData() {
    return (
        ...
        STORY_DATA.characters.length ||
        STORY_DATA.chapters.length
    );
}
...
export function renderStory() {
    ...
    editedBtn.onclick = async () => {
        ...
        if (Filesystem !== null) {
            ...
            const defaultFileName = fileName(STORY_DATA.title) + "_edited.txt";
